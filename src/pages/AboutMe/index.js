...
import coverImage from "assets/about-me_cover.png"
import aboutMeImage from "assets/about-me_picture.png"
    ...
    return (
        ...
        >
            ...
            <img
                ...
                className={styles['about-me-picture']}
            />

            <p className={styles['about-me-paragraph']}>
